...
function createTempleCard() {
        temples.forEach(temple => {
                // Create elements
                let card = document.createElement('#temple-cards');
                ...
                location.innerHTML="<span id='location'>Location:</span> " + temple.location;
                dedicated.innerHTML="<span id='dedication'>Dedicated:</span> " + temple.dedicated;
                area.innerHTML="<span id='area'>Area:</span> " + temple.area + " sq ft";
