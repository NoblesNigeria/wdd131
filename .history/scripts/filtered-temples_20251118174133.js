...
function createTempleCard() {
        temples.forEach(temple => {
                ...
                location.innerHTML="<span class='location'>Location:</span> " + temple.location;
                dedicated.innerHTML="<span class='dedication'>Dedicated:</span> " + temple.dedicated;
                area.innerHTML="<span class='area'>Area:</span> " + temple.area + " sq ft";
