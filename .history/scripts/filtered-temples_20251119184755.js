...
function createTempleCard() {
        temples.forEach(temple => {
                ...
                location.innerHTML="<span class='location'></span>" + temple.location;
                dedicated.innerHTML="<span class='dedication'></span> " + temple.dedicated;
                area.innerHTML="<span class='area'></span> " + temple.area + " sq ft";
